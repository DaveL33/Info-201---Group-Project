    ...
    sidebarLayout(
      ...
      mainPanel(
        tabsetPanel(
          ...
          br(),
          p("For this project, we will be learning to work with the Shiny framework for R. Since there are thousands of different items in Runescape, we will need an interactive web application that allows users to query information about specific in-game items, most likely via drop down inputs. The Shiny app will allow users to ask questions about the data set, and we will also use Plotly to visualize information that we find about our data set, via charts and graphs."),
          br(),
